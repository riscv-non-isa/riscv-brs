...
| `SBI_080`  | The  SBI v3.0 Debug Triggers (DBTR) extension MUST be implemented if the ISA extension Sdtrig cite:[Sdtrig] is present.
| `SBI_090`  | The SBI v3.0 Supervisor Software Events (SSE) extension MUST be implemented if the system supports the Firmware-First RAS (Reliability, Availability, and Serviceability) feature.
|===
