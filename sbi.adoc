...
| `SBI_070`  | If the interface type in the SPCR table is 0x15, it MUST support either the Debug Console Extension (DBCN) or both Console putchar Extension (EID #1) and Console getchar Extension (EID #2).
|===
